 ...
 */
function connect(wantedState, definedMutators) {
  function mapActionsToProps(updateStore) {
    if (Boolean(definedMutators)) {
      return Object.keys(definedMutators).reduce(function (accumulatedMutators, mutator) {
    ...
    return function (props) {
      return (0, _inferno.createComponentVNode)(2, StoreContext.Consumer, {
        children: function children(context) {
          return (0, _inferno.normalizeProps)((0, _inferno.createComponentVNode)(2, WrappedComponent, _extends({}, mapStateToProps(), mapActionsToProps(context.updateStore), props)));
        }
      });
    };
  };
              ...
              var tick = function tick() {
                if (Date.now() >= callTime) {
                  _this.setState({
                    ...
                    _this.persist();
                    if (callback) callback(_extends({}, storeState));
                  });
                } else {
